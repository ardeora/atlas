import { PathOptions, Path, LatLng, LatLngExpression } from 'leaflet';
...
declare module 'leaflet' {
  ...
  export class ShapeMarker<P> extends Path {
  ...
  export function shapeMarker(position: LatLngExpression, options: SVGShapeMarkerOptions): ShapeMarker;
}
